...
public:
    ...
    ChessBoard(Player White, Player Black) {
        ...
        std::cout << "Okay, functionet das? " << Board[4][1]->getPos().getX() << " and " << Board[4][1]->getPos().getY() << std::endl;
//        Board[4][1]->Piecetype();
